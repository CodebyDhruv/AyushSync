          ...
          >
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M23.498 6.186a2.974 2.974 0 0 0-2.093-2.106C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.405.58a2.974 2.974 0 0 0-2.093 2.106C0 8.093 0 12 0 12s0 3.907.502 5.814a2.974 2.974 0 0 0 2.093 2.106C4.495 20.5 12 20.5 12 20.5s7.505 0 9.405-.58a2.974 2.974 0 0 0 2.093-2.106C24 15.907 24 12 24 12s0-3.907-.502-5.814ZM9.75 15.5v-7l6 3.5-6 3.5Z"
              />
            </svg>
          </a>
        </div>
